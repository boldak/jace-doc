...
class Processor {
  ...
  async process() {
    ...
    this.assets = await this.processCss();
    this.files = await this.copyStaticFiles();
    ...
    this.renderer.addGlobal("assets", _.extend({}, this.assets, fo));
  ...
  async processMarkdown() {
    ...
    // this.log(`✅ ${data.length} pages are processed.`);
